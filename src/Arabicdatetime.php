...
namespace Maherelgamil\Arabicdatetime;
    ...
    protected function transTime(array $remaining)
    {
        ...
        if (isset($remaining['years'])) {
            if ($remaining['years'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_year');
            } elseif ($remaining['years'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_years');
            } elseif ($remaining['years'] > 2 && $remaining['years'] < 11) {
                $statement .= intval($remaining['years']).' '.trans('arabicdatetime::general.years');
            } else {
                $statement .= intval($remaining['years']).' '.trans('arabicdatetime::general.year');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['months'])) {
            if ($remaining['months'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_month');
            } elseif ($remaining['months'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_months');
            } elseif ($remaining['months'] > 2 && $remaining['months'] < 11) {
                $statement .= intval($remaining['months']).' '.trans('arabicdatetime::general.months');
            } else {
                $statement .= intval($remaining['months']).' '.trans('arabicdatetime::general.month');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['weeks'])) {
            if ($remaining['weeks'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_week');
            } elseif ($remaining['weeks'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_weeks');
            } elseif ($remaining['weeks'] > 2 && $remaining['weeks'] < 11) {
                $statement .= intval($remaining['weeks']).' '.trans('arabicdatetime::general.weeks');
            } else {
                $statement .= intval($remaining['weeks']).' '.trans('arabicdatetime::general.week');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['days'])) {
            if ($remaining['days'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_day');
            } elseif ($remaining['days'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_days');
            } elseif ($remaining['days'] > 2 && $remaining['days'] < 11) {
                $statement .= intval($remaining['days']).' '.trans('arabicdatetime::general.days');
            } else {
                $statement .= intval($remaining['days']).' '.trans('arabicdatetime::general.day');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['hours'])) {
            if ($remaining['hours'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_hour');
            } elseif ($remaining['hours'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_hours');
            } elseif ($remaining['hours'] > 2 && $remaining['hours'] < 11) {
                $statement .= intval($remaining['hours']).' '.trans('arabicdatetime::general.hours');
            } else {
                $statement .= intval($remaining['hours']).' '.trans('arabicdatetime::general.hour');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['minutes'])) {
            if ($remaining['minutes'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_minute');
            } elseif ($remaining['minutes'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_minutes');
            } elseif ($remaining['minutes'] > 2 && $remaining['minutes'] < 11) {
                $statement .= intval($remaining['minutes']).' '.trans('arabicdatetime::general.minutes');
            } else {
                $statement .= intval($remaining['minutes']).' '.trans('arabicdatetime::general.minute');
            }
            $statement .= ' ';
        ...
        if (isset($remaining['seconds'])) {
            if ($remaining['seconds'] == 1) {
                $statement .= ' '.trans('arabicdatetime::general.one_second');
            } elseif ($remaining['seconds'] == 2) {
                $statement .= ' '.trans('arabicdatetime::general.two_seconds');
            } elseif ($remaining['seconds'] > 2 && $remaining['minutes'] < 11) {
                $statement .= intval($remaining['seconds']).' '.trans('arabicdatetime::general.seconds');
            } else {
                $statement .= intval($remaining['seconds']).' '.trans('arabicdatetime::general.second');
            }
        }
